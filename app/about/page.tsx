  ...
  return (
    <section>
      ...
      <p className="mt-6 text-lg tracking-wide leading-8 max-w-2xl mx-auto text-muted-foreground">
        ...
        Northern Virginia area way way back in 1995. We couldn't afford Solaris,
        learned about a free UNIX-like OS, and spent almost an entire day
        downloading it onto over 50 floppies for installation on an old 486
        ...
        we've continued to grow our product line, expand our staff (including
        several canines) and enhance the way we interface with customers. Who
        would have thought...
      </p>
    </section>
  );
